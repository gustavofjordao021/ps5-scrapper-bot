...
exports.MicroCenter = void 0;
const config_1 = require("../../config");
const logger_1 = require("../../logger");
const microCenterLocations = config_1.config.store.microCenterLocation;
const microCenterLocationToId = new Map([
    ['web', '029'],
    ['brooklyn', '115'],
    ['brentwood', '095'],
    ['cambridge', '121'],
...
for (const microCenterLocation of microCenterLocations) {
    if (microCenterLocationToId.get(microCenterLocation) === undefined) {
        ...
        logger_1.logger.warn(logString);
    }
    else {
...
//# sourceMappingURL=microcenter.js.map