...
exports.AmazonDe = {
    ...
    links: [
        {
            brand: 'test:brand',
            cartUrl: 'https://www.amazon.de/gp/aws/cart/add.html?ASIN.1=B07PW9VBK5&Quantity.1=1',
            model: 'test:model',
            series: 'test:series',
        ...
        {
            brand: 'sony',
            cartUrl: 'https://www.amazon.de/gp/aws/cart/add.html?ASIN.1=B08H93ZRK9&Quantity.1=1',
            labels: {
                inStock: {
        ...
        {
            brand: 'sony',
            cartUrl: 'https://www.amazon.de/gp/aws/cart/add.html?ASIN.1=B08H98GVK8&Quantity.1=1',
            labels: {
                inStock: {
                    container: '#productTitle',
                    text: ['sony playstation 5']
...
//# sourceMappingURL=amazon-de.js.map