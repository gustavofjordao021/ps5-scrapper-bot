...
exports.NeweggCa = {
    ...
    links: [
        ...
        },
        {
            ...
            model: 'aorus xtreme',
            series: '3080',
            url: 'https://www.newegg.ca/gigabyte-geforce-rtx-3080-gv-n3080aorus-x-10gd/p/N82E16814932345'
        },
        {
            brand: 'zotac',
    ...
    realTimeInventoryLookup: async (itemNumber) => {
        const request_url = 'https://www.newegg.ca/product/api/ProductRealtime?ItemNumber=' +
            itemNumber;
        const response = await node_fetch_1.default(request_url);
        const response_json = await response.json();
        return (response_json.MainItem !== undefined &&
            response_json.MainItem.Instock === true);
    }
};
//# sourceMappingURL=newegg-ca.js.map